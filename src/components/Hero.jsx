  ...
  return (
    ...
    >
      ...
      <img
        ...
        className="hidden lg:block absolute top-1/2 right-[-7%] -translate-y-1/2 w-[48vw] xl:w-[54vw] 2xl:w-[88vw] max-w-300 opacity-95 pointer-events-none select-none z-2 animate-float"
      />
      ...
      <div className="relative z-10 max-w-350 mx-auto px-6 sm:px-8 lg:px-12 w-full">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] min-h-screen items-center pt-28 lg:pt-24 pb-36 lg:pb-20">
          ...
          <div className="max-w-225">
            <p className="text-[#6F00FF] uppercase tracking-[4px] font-bold text-xs sm:text-sm mb-7 mt-5">
